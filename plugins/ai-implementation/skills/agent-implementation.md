...
1. シリーズ目次を WebFetch で取得: https://pubs.u-biosis.com/ai/agent-implementation/
2. 相談内容に該当する章を特定し、その章の URL を WebFetch
3. 設計層の問題なら `ai-design` スキルに切り替えるか併用
...
| 相談内容 | URL |
|---|---|
| 「壊れるパターン」「破綻分析」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-00.ja.html |
| 「5層構造」「Layer 1〜5」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-01.ja.html |
| 「自律 vs 伴走」「LLM 任せの境界」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-02.ja.html |
| 「フレームワーク選定」「Dify / LangGraph / AutoGen / AgentEngine」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-03.ja.html |
| 「文脈OS 実装」「Role / Values / Rules / Scope」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-04.ja.html |
| 「タスクOS」「MCP」「実行の外部化」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-05.ja.html |
| 「メモリOS」「永続レポート」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-06.ja.html |
| 「安定性OS」「文脈分離・実行外部化・時間固定化」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-07.ja.html |
| 「OS 統合」「Role / Memory / Task / Reports の組み合わせ」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-08.ja.html |
| 「フレームワーク思想比較」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-09.ja.html |
| 「実装ロードマップ」「30/90/180 日」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-10.ja.html |
| 「品質保証OS」「多層検証」「eval 設計」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-11.ja.html |
| 「補足: 確率的システムの品質保証」 | https://pubs.u-biosis.com/ai/agent-implementation/chapter-quality-assurance.html |
