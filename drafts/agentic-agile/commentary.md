...
原則の側に説明を書かない方針をとっている。規範文書が持つのは「何に従うか」であり、「なぜそれに従うか」を同じ文書に置くと、理由への同意が遵守の条件になってしまう。理由は、従う根拠ではなく、改訂を議論するときの材料として、別の場所に置く。改訂の根拠そのものは書き直し案 §1 が定める観測——案件規則の改訂記録のうち、本書が妨げになった、または不足していた事例——であって、解説ではない。
...
ただし、表に現れない変更が二つある。一つは目的である。v1 の目的は G1「価値を早く継続的に届ける」だったが、書き直し案の目的は「人間の判断を、最も価値のある判断に使い切る」に入れ替わっている。原則の並べ替えより大きい変更で、指針 D1 の内容が目的の位置に上がった形になっている。もう一つは、v1 A4 の前半——同じモデルが同じ誤りを共有しうること——が、指針ではなく §2 の前提に移ったことである。A4 の残り、すなわち生成と判定を分ける部分だけが D3 になっている。
...
ただし、これを「誰も気づいていない」と言うことはできない。空白の指摘は既にある。ICSE 2026 併設ワークショップ AGENT '26（ACM）の Hoda は、これまでの構想がコーディングという一つの活動の周辺に集中していると述べたうえで、AI のチームメイトを開発の全工程にどう組み込むかについての指針は現在存在しない、と明言している。したがって主張しうるのは「気づいた」ではない。かといって「埋めた」でもない。ここで書いている体系も、先に見たとおり根の承認手続きは外に置いている。循環を体系の内側に入れたのは、根より下の規範文書についてだけである。
