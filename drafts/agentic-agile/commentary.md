...
さらに、対応する ID を持ちながら内容が動いた箇所が三つある。D3 の「自らの成果を自ら承認しない」には v1 A4 に対応する文がなく、追加されたものである。B1 の「エージェントが参照・送信できる情報」は D6 で「実行者が参照・送信できる情報」になり、人間を含む範囲に広がった。観測の記述も、v1 の「本書の原則が妨げになった、または不足していた事例」から書き直し案の「本書が妨げになった、または不足していた事例」に変わり、原則だけでなく指針と前提も見直しの根拠に入っている。
