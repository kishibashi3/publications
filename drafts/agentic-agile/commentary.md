...
v1 は 6 つを横並びに置いていた。書き直し案は、そのうち何が原則で何が原則から出るものかを分けている。v1 に対応する言明がまったくない原則は P2 だけである。
...
前提の側にも、v1 にそのまま対応しない部分がある。§2 の「実行は安く、速く、いくらでも繰り返せる」のうち、v1 A1 にあるのは「実行は安価であり」までで、「速く、いくらでも繰り返せる」は広げたものである。「出力は確率的にばらつき」に至っては、対応する言明が v1 にない。概念として近いのは A3「品質は点ではなく分布として扱う」だが、A3 は D5 にそのまま残っているので、前提と指針に分けた結果でもない。残る「同じ生成元は同じ誤りを共有する」は、前述のとおり A4 の前半が移ったものだが、そのまま移ったわけではない。A4 は「同じモデルが同じ文書から生成したものは、同じ誤りを共有しうる」で、モデルと文書という二つの同一性を条件に置き、共有は起こりうることとして書かれていた。§2 は条件を「同じ生成元」に縮め、「共有する」と言い切っている。条件が緩み、同時に言明が強まっている。
