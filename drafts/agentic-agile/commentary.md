...
前提の側にも、v1 に対応がない部分がある。§2 の「実行は安く、速く、いくらでも繰り返せる」のうち、v1 A1 にあるのは「実行は安価であり」までで、「速く、いくらでも繰り返せる」は広げたものである。「出力は確率的にばらつき」に至っては v1 のどの言明にも対応がない。A3「品質は点ではなく分布として扱う」は D5 にそのまま残っているので、A3 を前提と指針に分けた結果でもない。
