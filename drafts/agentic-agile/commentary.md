...
そのうえで、準拠先 §2 は「改訂を提起した者は、その改訂を承認しない」と定めている。これは準拠先に既に書かれていることの紹介であって、本書がそれを定めているのではない。執行しながら下位を書くことは許し、自分が提起した改訂を自分で承認することは許さない。この非対称が、二重性を利益相反にしないための仕掛けになっている。
