---
title: "第4章：エージェントOS実装 ― 文脈制御の具体化"
date: 2025-12-07
type: publication
tags: [ai-agent, implementation, context-os, agent-memory]
status: published
ai-reviewed: false
---
...
- → LLMには「切り替えスイッチ」が存在しない。Extended ThinkingやSystem Promptの進化で「1つの文脈内で深く考える能力」は向上したが、それは「文脈を切り替える機構」ではない
- → 文脈が混ざり人格が壊れる
